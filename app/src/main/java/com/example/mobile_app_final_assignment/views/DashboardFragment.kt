...
class DashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        navigationFunctionLambda = { findNavController().navigate(DashboardFragmentDirections.actionDashboardFragmentToDetailsFragment(description = it)) }
        ...
        lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                viewModel.greetingText.collect { greetingTextState ->
                    view.findViewById<TextView>(R.id.dashSubtitleText).text = greetingTextState
                }
            }
        }
